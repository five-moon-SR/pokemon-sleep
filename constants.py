...
# ---------------------------------------------------------------------------
EVALUATION_VERSION: str = "v1.4"  # 2026-07-23 ランク帯を独自キャリブレーションへ
...
# 品質アンカー: C=無補正中央/B=並/A=良(金1+スピM)中央/S=良と優の中間/SS=優中央/増田=優上位10%。
RANK_THRESHOLDS_BY_TYPE: dict[int, list[tuple[float, str]]] = {
    1: [(101.0, "増田"), (99.0, "SS"), (88.5, "S"), (76.5, "A"), (48.5, "B"), (44.5, "C")],
    2: [(100.5, "増田"), (93.5, "SS"), (81.0, "S"), (68.5, "A"), (45.0, "B"), (41.0, "C")],
    3: [(100.5, "増田"), (93.5, "SS"), (81.0, "S"), (68.5, "A"), (45.0, "B"), (41.0, "C")],
    4: [(100.5, "増田"), (93.5, "SS"), (81.0, "S"), (68.5, "A"), (45.0, "B"), (41.0, "C")],
    5: [(81.5, "増田"),  (79.5, "SS"), (73.5, "S"), (66.0, "A"), (46.0, "B"), (42.0, "C")],
    6: [(100.5, "増田"), (93.5, "SS"), (81.0, "S"), (68.5, "A"), (45.0, "B"), (41.0, "C")],
    7: [(81.0, "増田"),  (79.0, "SS"), (74.0, "S"), (66.5, "A"), (41.5, "B"), (34.5, "C")],
    8: [(100.5, "増田"), (93.5, "SS"), (81.0, "S"), (68.5, "A"), (45.0, "B"), (41.0, "C")],
    9: [(93.5, "増田"),  (91.5, "SS"), (82.0, "S"), (71.0, "A"), (37.0, "B"), (29.5, "C")],
}
